...
namespace EdlinSoftware.Safe.SafeLib.DataFields
{
	...
	/// </summary>
	[Serializable]
    public class PasswordDataField : IDataField
	{
		#region Fields
		/// <summary>
		/// Name of data field.
		...
		protected readonly string m_Name = "Password field";
		/// <summary>
		/// Control for entering user information.
		/// </summary>
		[DebuggerBrowsable( DebuggerBrowsableState.Never )]
        protected readonly PasswordDataFieldControl m_FieldControl = new PasswordDataFieldControl();
		/// <summary>
		...
		{
			[DebuggerStepThrough]
			get { return Resources.TextDataField; }
		}
		...
		{
			m_Text = m_FieldControl.Password;
		}
		...
		public PasswordDataField( SerializationInfo info, StreamingContext context )
		{
			...
			m_FieldControl.Password = m_Text;
		}
		#endregion
