...
{
	/// <summary>
	/// Data field with text box.
	/// </summary>
	[Serializable]
	public class TextDataField : IDataField
	{
		#region Fields
		/// <summary>
		/// Name of data field.
		...
		protected readonly string m_Name = "Text field";
		/// <summary>
		/// Control for entering user information.
		/// </summary>
		[DebuggerBrowsable( DebuggerBrowsableState.Never )]
		protected readonly TextDataFieldControl m_FieldControl = new TextDataFieldControl();
		/// <summary>
		...
		public TextDataField( SerializationInfo info, StreamingContext context )
		{
